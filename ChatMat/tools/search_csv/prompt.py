...
The index of the dataframe must be be one of {df_index}. You can determine which index to use based on the problem. The specific meanings of the names of the indexes are as follows:
- Etot: total energy
- Efree: free energy
...
-Force for centroid (x) [a.u.],Force for centroid (y) [a.u.],force for centroid (z) [a.u.],Max force magnitude [a.u.]: The force on the center of mass in the x, y, and z directions
