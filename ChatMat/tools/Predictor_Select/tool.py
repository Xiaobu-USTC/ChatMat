...
from ChemAgent2pl.ChatMat.tools.Predictor_Select.base import Predictor
...
def _get_predict_properties(
    ...
    return Tool(
        ...
        description=(
            ...
            "More imprecise than the dataset_search tool, but can be used universally. "
            "If you didn't get the properties of the substance using the dataset_search tool, try using the predictor tool."
