...
AVAILABLE_TOOLS = [
    {"name": "FP Predictor", "description": "This tool performs first-principles (FP) calculations to predict molecular properties. Use it for detailed, physics-based property predictions."},
    {"name": "ML Predictor", "description": "This tool utilizes machine learning-driven potential energy surface (PES) models to predict molecular properties based on trained data. Ideal for high-efficiency predictions."},
    {"name": "Predictor Select", "description": "This tool helps select the appropriate prediction model (FP or ML) based on the task. Use it to optimize the property prediction process."},
    {"name": "Dataset Search", "description": "This tool searches databases to retrieve molecular property data. Use it when looking for existing data for a specific molecule or material."},
